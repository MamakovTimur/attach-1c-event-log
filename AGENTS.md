...
Правка `.bsl` / `Form.xml` / корневого XML — обычными файловыми инструментами Codex. Это выгрузка EPF, не EDT.
...
Не использовать агентов `1c-explorer`, `1c-metadata-manager`, `1c-architect`, `1c-planner`: они относятся к конфигурациям и чужим индексам. При делегировании передавать цель, точные пути файлов и уже прочитанный контекст.
